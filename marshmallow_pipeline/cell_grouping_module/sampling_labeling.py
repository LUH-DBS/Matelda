...
def cell_clustering(table_cluster, col_cluster, x, y, n_cell_clusters_per_col_cluster): 
    logging.info("Cell Clustering - table_cluster: %s, col_cluster: %s", table_cluster, col_cluster)
    clustering = None 
    cells_per_cluster = {}
    errors_per_cluster = {}
    ...
    logging.info("KMeans - n_cell_clusters_per_col_cluster: %s", n_cell_clusters_per_col_cluster)
