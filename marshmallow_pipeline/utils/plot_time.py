...
standard = pd.read_csv("/home/fatemeh/ED-Scale-mp-dgov/ED-Scale/final_csv_results/quintet_standard_time.csv")
classi = pd.read_csv("/home/fatemeh/ED-Scale-mp-dgov/ED-Scale/final_csv_results/quintet_optimized_time.csv")
# Extract time values
...
plt.title('Comparison of Execution Time - Quintet: classify per column, unlabeled clusters, vs Standard')
