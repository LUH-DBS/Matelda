...
def get_res_df_eds(labeling_budgets, res_path, nested_dir_name, exp_name, exec):
    res_dict = {"labeling_budget": [], "precision": [], "recall": [], "fscore": [], "time": []}
...
res_path = "/home/fatemeh/ED-Scale-mp-dgov/ED-Scale/Quintet-unlabelled-standard-Exp"
exp_name = "unlabeled_Quintet"
...
res_df_eds.to_csv(os.path.join("/home/fatemeh/ED-Scale-mp-dgov/ED-Scale/final_csv_results", "quintet_standard_unlabeled.csv"), index=False)