...
dirty_df_path = 'Alcohol-use.g8_2014_0731_0900/dirty_clean.csv'
clean_df_path = 'Alcohol-use.g8_2014_0731_0900/clean.csv'
errors_df_path = 'Alcohol-use.g8_2014_0731_0900/clean_changes.csv'
